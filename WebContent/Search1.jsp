...
<body>   
 <div class="header" >
      ...
      <li><a href=""> Properties</a>
          <ul>
              <li><a href="AvailableProperties.jsp" >Available</a></li>
...
/*int idproperties = Integer.parseInt(num);*/
		try {
            ...
            //String sql = "SELECT * FROM properties where Location="+loc;
            int bhkno=Integer.parseInt("bhk");
            String bhk=request.getParameter("bhkno");
			ResultSet rs=statement.executeQuery("SELECT IdProperty, OwnerName, PropertyName, PropertyType, BHK, Bathrooms, Location, ExpectedRent, ExpectedDeposit, AvailableFrom FROM properties where BHK="+bhkno+"'");
			
			out.print("<table align='left' cellspacing='1' cellpadding='1' border='5' bgcolor='#3399CC'>");
			out.print("<tr><th>IdProperty</th><th>OwnerName</th><th>PropertyName</th><th>PropertyType</th><th>BHK</th><th>Bathrooms</th><th>Location</th><th>ExpectedRent</th><th>ExpectedDeposit</th><th>AvailableFrom</th></tr>");
			while(rs.next()){
				...
				out.print("<tr>");
				out.print("<td>" + id + "</td>");
				out.print("<td>" + oname + "</td>");
				out.print("<td>" + pname + "</td>");
				out.print("<td>" + ptype + "</td>");
				out.print("<td>" + bhkn + "</td>");
				out.print("<td>" + bathrooms + "</td>");
				out.print("<td>" + locat + "</td>");
				out.print("<td>" + rent + "</td>");
				out.print("<td>" + depo + "</td>");
				out.print("<td>" + avail + "</td>");
				out.print("</tr>");
