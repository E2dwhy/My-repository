...
/*int idproperties = Integer.parseInt(num);*/
		try {
            ...
            String sql = "SELECT idFinance, PropertyName, PropertyOwner, RentedBy, AmountPaid, DateOfPayment, Balance FROM finance";
			ResultSet rs=statement.executeQuery(sql);
			
			out.print("<table align='left' cellspacing='1' cellpadding='1' border='5' bgcolor='#3399CC'>");
			out.print("<tr><th>idFinance</th><th>PropertyName</th><th>PropertyOwner</th><th>RentedBy</th><th>AmountPaid</th><th>Date</th><th>Balance</th></tr>");
			while(rs.next()){
			    //int idproperties1=rs.getInt(1);
				//session.setAttribute("idproperties",idproperties1);
				 int id  = rs.getInt("idFinance");      
		         String pname = rs.getString("PropertyName");
		         String oname = rs.getString("PropertyOwner");
		         String renting = rs.getString("RentedBy");
		         double paid = rs.getDouble("AmountPaid");
		         String date = rs.getString("DateOfPayment");
				...
				out.print("<td>" + renting + "</td>");
				out.print("<td>" + paid + "</td>");
